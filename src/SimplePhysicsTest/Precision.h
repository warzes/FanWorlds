...
//  Interface file for code that changes when the core's precision is altered.

/**
 * Because engine is designed to work at either single or double precision, mathematical functions such as sqrt cannot be used
 * in the source code or headers. This file provides defines for the real number type and mathematical formulae that work on it.
 */
...
#if SINGLE_PRECISION
/**
* Defines a real number precision. Engine can be compiled in
