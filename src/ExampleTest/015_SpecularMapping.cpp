...
{
	Print("_015SpecularMapping Create");
...
{{ 1.0f, -1.0f,  1.0f}, {1.0f, 1.0f}, { 0.0f, -1.0f,  0.0f}},
	...
	m_geom = renderSystem.CreateGeometryBuffer(BufferUsage::StaticDraw, Countof(vert), sizeof(_015Vertex), vert, m_shader);
...
void _015SpecularMapping::Destroy()
{
	...
	Print("_015SpecularMapping Destroy");
}
//-----------------------------------------------------------------------------
