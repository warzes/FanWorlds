...
//-----------------------------------------------------------------------------
bool _008Framebuffer::Create()
{
	Print("008 Framebuffer Create");
...
void main()
{
	...
	m_geomBox = renderSystem.CreateGeometryBuffer(BufferUsage::StaticDraw, Countof(cubeVertices), sizeof(float), cubeVertices, m_shader);
	...
	m_geomPlane = renderSystem.CreateGeometryBuffer(BufferUsage::StaticDraw, Countof(planeVertices), sizeof(float), planeVertices, m_shader);
	...
	m_geomQuad = renderSystem.CreateGeometryBuffer(BufferUsage::StaticDraw, Countof(quadVertices), sizeof(float), quadVertices, screenShader);
...
//-----------------------------------------------------------------------------
void _008Framebuffer::Update(float deltaTime)
{
