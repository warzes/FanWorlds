...
{
	Print("_014NormalMapping Create");
...
{{ 1.0f, -1.0f,  1.0f}, {1.0f, 1.0f}, { 0.0f, -1.0f,  0.0f}},
	...
	m_geom = renderSystem.CreateGeometryBuffer(BufferUsage::StaticDraw, Countof(vert), sizeof(_014Vertex), vert, m_shader);
...
void _014NormalMapping::Destroy()
{
	...
	Print("_014NormalMapping Destroy");
}
//-----------------------------------------------------------------------------
