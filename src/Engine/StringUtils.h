...
namespace StringUtils
{
	...
	{
		return StringUtils::strcasecmp(s, T("true")) 
			|| StringUtils::strcasecmp(s, T("on")) 
			|| StringUtils::strcasecmp(s, T("yes")) 
			|| StringUtils::strcasecmp(s, T("1"));
	}

	template <typename T> bool isfalse(T const& s)
	{
		return StringUtils::strcasecmp(s, T("false")) 
			|| StringUtils::strcasecmp(s, T("off")) 
			|| StringUtils::strcasecmp(s, T("no")) 
			|| StringUtils::strcasecmp(s, T("0"));
	}
	...
	{
		trim(s);
		if( StringUtils::strcasencmp(s, std::string_view("0x"), 2) )
		{
